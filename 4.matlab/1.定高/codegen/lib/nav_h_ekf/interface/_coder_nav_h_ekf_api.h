...
extern void nav_h_ekf_api(const mxArray *prhs[6], const mxArray *plhs[3]);
extern void nav_h_ekf(float Q[16], float H[8], float R[4], float F[16], float I[16], float Z[2], float *h, float *v, float *a);
